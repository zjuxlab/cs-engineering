...
`man` 的作用是打开一个 user **man**ual。例如，如果我们在终端中输入 `man man`，就会得到如下结果，即使用 `man` 打开了 `man` 的手册：
...
> ```
>
> - **Copy from the top answer from:** **https://unix.stackexchange.com/questions/84620/what-does-sh-a-sh-0-0-mean**
